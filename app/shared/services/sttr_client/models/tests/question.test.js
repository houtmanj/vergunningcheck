...
const getQuestion = () => new Question('aaa', 'boolean', 'Are you ok?', 'Describe how you are _feeling_.');
...
describe('Question', () => {
  ...
  test('answer', () => {
    ...
    expect(() => question.setAnswer('goooo')).toThrow("value 'goooo' not valid for Answer of type boolean");
  });
});
