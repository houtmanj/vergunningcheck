...
import { GET_CURRENT_TOPIC, PAGES, booleanOptions, GET_TEXT } from '../../constants';
...
const ResultsPage = () => {
  ...
  return (
    <>
      ...
      >
        <Paragraph strong>
          Hieronder kunt u per vraag uw gegeven antwoord teruglezen en eventueel wijzigen. Als u een wijziging doet moet
          u misschien enkele vragen opnieuw beantwoorden.
        </Paragraph>
        <MainWrapper>
